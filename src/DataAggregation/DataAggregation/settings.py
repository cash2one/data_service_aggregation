...
#"""指定配置时，千万别乱加逗号，不然小心使得配置对象由string类型变成了tuple类型"""

"""
Django settings for DataAggregation project.
...
#   'django.middleware.cache.UpdateCacheMiddleware',
    ...
    'DataAggregation.middleware.LoginAuthenticationMiddleware',
    'DataAggregation.middleware.ServeAgentMiddleware',
...
ROOT_URLCONF = 'DataAggregation.urls'
...
WSGI_APPLICATION = 'DataAggregation.wsgi.application'
...
DEFAULT_FILE_STORAGE = 'DataAggregation.storage.DataMallFileStorage' #自定义文件上传命名规则  
#DEFAULT_FILE_STORAGE = 'django.core.files.storage.FileSystemStorage'

STATIC_URL = '/aggregation/static/'
STATIC_ROOT = '/website/DataAggregation/src/DataAggregation/static'
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': '/var/log/django/data_aggre.log',
        },
    },
    'loggers': {
        'fileout': {
...
SESSION_COOKIE_AGE=60*60*2 #30分钟session有效期，UTC时间，比实际时间早8小时
